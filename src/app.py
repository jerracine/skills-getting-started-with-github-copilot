...
activities = {
    ...
    "Basketball Team": {
        ...
        "max_participants": 15,
        "participants": ["mason@mergington.edu", "noah@mergington.edu"]
    },
    "Swimming Club": {
    ...
    "Art Club": {
        "description": "Explore visual arts through painting, drawing, and design",
    ...
    "Debate Team": {
        "description": "Practice public speaking, critical thinking, and debate tournaments",
